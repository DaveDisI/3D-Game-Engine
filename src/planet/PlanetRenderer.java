...
public class PlanetRenderer {
	...
	public void render(Map<TexturedModel, List<Planet>> entities){
		for(TexturedModel model : entities.keySet()){
			prepareTexturedModel(model);
			List<Planet> batch = entities.get(model);
			
			for(Planet entity : batch){
	...
	private void prepareInstance(Planet entity){
